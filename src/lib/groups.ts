...
export const formatMoney = (amount: number, currency: IncomeCurrency) => new Intl.NumberFormat('en-US', { style:'currency', currency, currencyDisplay:'narrowSymbol', maximumFractionDigits:2 }).format(amount);
